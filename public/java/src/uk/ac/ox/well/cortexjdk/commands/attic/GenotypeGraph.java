package uk.ac.ox.well.cortexjdk.commands.attic;
...
import uk.ac.ox.well.cortexjdk.utils.alignment.pairwise.ExternalAligner;
import uk.ac.ox.well.cortexjdk.utils.alignment.pairwise.LastzAligner;
import uk.ac.ox.well.cortexjdk.utils.arguments.Argument;
import uk.ac.ox.well.cortexjdk.utils.arguments.Output;
import uk.ac.ox.well.cortexjdk.utils.containers.DataTable;
import uk.ac.ox.well.cortexjdk.utils.containers.DataTables;
...
//        }
    ...
    public void execute() {
        ...
        if (novelKmers.size() > NOVEL_KMER_LIMIT) {
            throw new CortexJDKException("Too many novel kmers (for now)");
        }
