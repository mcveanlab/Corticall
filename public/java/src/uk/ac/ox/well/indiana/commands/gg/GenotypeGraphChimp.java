...
public class GenotypeGraphChimp extends Module {
    ...
    private int[] getHaplotypeBackgroundVector(String alignmentStretch, KmerLookup kl, KmerLookup kl1, KmerLookup kl2) {
        ...
        for (int i = 0; i < hb.length; i++) {
            ...
            if (hb[i] == 3) {
                ...
                Set<Interval> sis = kl1.findKmer(sk);
...
//        }
    ...
    private List<SAMRecord> getAlignment(String alignmentStretch, KmerLookup kl, KmerLookup kl1, KmerLookup kl2) {
        int[] hb = getHaplotypeBackgroundVector(alignmentStretch, kl, kl1, kl2);
    ...
    public void execute() {
        ...
        for (CortexKmer novelKmer : novelKmersToVisit) {
            if (novelKmers.get(novelKmer)) {
                ...
                List<SAMRecord> alignments = getAlignment(alignmentStretch, kl, kl1, kl2);
