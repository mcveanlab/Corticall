    ...
    public void execute() {
        ...
        while ((c = FASTA.nextSequence()) != null) {
            ...
            for (int i = 0; i < b.length - KMER_SIZE; i++) {
                ...
                String b2 = new String(SequenceUtils.alphanumericallyLowestOrientation(b1));
            ...
            if (transcripts.containsKey(contigName)) {
                for (Transcript t : transcripts.get(contigName)) {
                    ...
                    for (int i = 0; i < transcriptBases.length - KMER_SIZE; i++) {
                        String kmer = new String(SequenceUtils.alphanumericallyLowestOrientation(Arrays.copyOfRange(transcriptBases, i, i + KMER_SIZE)));
