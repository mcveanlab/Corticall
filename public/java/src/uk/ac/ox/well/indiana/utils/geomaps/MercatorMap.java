package uk.ac.ox.well.indiana.utils.geomaps;
...
public class MercatorMap {
     ...
     * @return The screen coordinates with (x, y).
     */
    ...
    private float getScreenYRelative(float latitudeInDegrees) {
        return (float) Math.log(Math.tan(latitudeInDegrees / 360 * Math.PI + Math.PI / 4));
    }
