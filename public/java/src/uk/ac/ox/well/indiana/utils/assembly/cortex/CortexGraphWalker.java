...
public class CortexGraphWalker {
    ...
    private DirectedGraph<CortexKmer, CortexEdge> buildLocalGraph(int color, CortexKmer panelKmer, boolean goLeft, int maxForks, DirectedGraph<CortexKmer, CortexEdge> g) {
        ...
        if (cortexMap.containsKey(panelKmer)) {
            //System.out.println("Start: color=" + color + " kmer=" + panelKmer + " goLeft=" + goLeft + " maxJunctions=" + maxJunctions + " numVertices=" + g.vertexSet().size());
            ...
            while (record != null && !seenKmers.contains(record.getCortexKmer()) && edges.size() == 1) {
                //System.out.println("\tTraverse: color=" + color + " kmer=" + new CortexKmer(currentKmer) + " goLeft=" + goLeft + " maxJunctions=" + maxJunctions + " numVertices=" + g.vertexSet().size());
                ...
                //System.out.println("\tNextkmer: color=" + color + " kmer=" + nextKmer + " goLeft=" + goLeft + " maxJunctions=" + maxJunctions + " numVertices=" + g.vertexSet().size());
            ...
            if (maxForks > 0 && edges.size() > 1) {
                ...
                for (Byte edge : edges) {
                    ...
                    //System.out.println("Branch from: color=" + color + " kmer=" + ck + " goLeft=" + goLeft + " maxJunctions=" + maxJunctions + " numVertices=" + g.vertexSet().size());
                    //System.out.println("Branch to  : color=" + color + " kmer=" + k2 + " goLeft=" + goLeft + " maxJunctions=" + maxJunctions + " numVertices=" + g.vertexSet().size());
